  ...
  return (
    <div>
      ...
      <div className="home-about" role="region" aria-labelledby="about-section">
        ...
        >
          <img
            ...
            alt="Team collaboration at Diliate"
            loading="lazy"
          />
        </motion.div>
          ...
          >
            <div className="about-sub">
              <div className="about-title">
                <h1 className="font-orbitron text-4xl trusted">
            ...
            <div className="about-text-container">
              <p className="about-text text-lg mt-4">
                Welcome to Diliate – where we turn digital dreams into
                decentralized reality!
              </p>
              <p className="about-text montserrat-font text-lg mt-8">
                We're your go-to squad for web development, SEO, content
                management, and Google Ads. We'll make your online presence
                hotter than a Delhi summer.
              </p>
              <p className="about-text montserrat-font text-lg mt-4">
                Why Us? We're not your average tech nerds – we're the Jedi
                masters of digital marketing. Let's soar to new heights
                together!
              </p>
              <p className="about-text montserrat-font text-lg mt-4">
                Slide into our DMs like you're making a smooth UPI transaction.
              </p>
            </div>
          </motion.div>
        </div>
                ...
                {[...Array(12)].map((_, i) => (
                  ...
                  >
                    <img
                      ...
                      src={`https://cdn.rareblocks.xyz/collection/celebration/images/logos/3/logo-${
                        i + 1
                      }.png`}
          ...
          >
            <div className="relative lg:mb-12">
              ...
              <div className="pl-12 pr-6">
                <img
                  ...
                  alt="Diliate expert working on a project"
                  loading="lazy"
                />
              </div>
                    ...
                    <div className="flex items-start">
                      ...
                      <blockquote className="ml-5">
                        <p className="text-sm font-medium text-white sm:text-lg">
                          They made it so simple. My new site is so much faster
            ...
            <div className="2xl:pl-16">
              <h2 className="text-3xl font-bold leading-tight text-black sm:text-4xl lg:text-5xl lg:leading-tight">
                We Make Things Easy for Projects at DILIATE
              </h2>
              <p className="text-xl leading-relaxed text-gray-900 mt-9">
                At Diliate, we ensure that your projects run smoothly and
                efficiently. Our solutions are designed to streamline processes
              ...
              <p className="mt-6 text-xl leading-relaxed text-gray-900">
                ...
                and support, ensuring that your goals are met with ease and
                precision.
              </p>
            </div>
          </div>
      ...
      <div
        ...
        role="region"
        aria-labelledby="process-section"
      >
        <Header
          spantext="PROCESS"
          image={ladder}
          content="Streamlined Digital Process"
          light={false}
        />
        <div id="process-section" className="illustrations">
          ...
          <motion.div
            className="illustration-content reverse"
          ...
          >
            <img
              src={notification}
              loading="lazy"
              alt="Project Management Efficiency"
            />
            <div className="illustration-text">
          ...
          >
            <img
              src={graphics}
              loading="lazy"
              alt="Tracking Key Performance Metrics"
            />
            <div className="illustration-text">
